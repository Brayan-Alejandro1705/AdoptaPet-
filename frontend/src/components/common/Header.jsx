  ...
  return (
    <header className="bg-gradient-to-r from-blue-500 via-purple-500 to-blue-500 shadow-lg sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-3 md:px-4 py-3 md:py-4 flex items-center justify-between">
        ...
        {/* Logo + Nombre */}
        <Link to="/" className="flex items-center gap-2 md:gap-3 cursor-pointer hover:scale-105 transition-transform">
        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          <Link to="/notificaciones" className="relative w-10 h-10 md:w-11 md:h-11 rounded-full bg-white flex items-center justify-center shadow-lg hover:shadow-xl hover:scale-110 active:scale-95 transition-all">
            ...
            <span className="absolute -top-1 -right-1 bg-red-500 text-white text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center animate-pulse-soft shadow-md">3</span>
          </Link>
          ...
          <Link to="/perfil" className="hidden md:block ml-2 text-white font-semibold hover:underline">Nombre de Usuario</Link>
        </div>
      </div>
      ...
      <div className="md:hidden px-3 pb-3">
        <div className="relative">
          <input type="text" placeholder="Buscar mascotas..." className="w-full px-4 py-2 pr-10 border-2 border-white/30 bg-white/90 backdrop-blur rounded-full focus:ring-2 focus:ring-white/50 outline-none shadow-lg text-sm" />
